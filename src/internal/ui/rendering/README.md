...
# Dependencies
This package should not not import any other UI package, and should have minimal, ideally zero, dependency on common, utils or any other gfm package. Its meant as a utilites to be used by ui components and main model. 
