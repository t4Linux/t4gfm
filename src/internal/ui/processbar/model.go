...
func (m *Model) RequestCancelAll() {
	m.cancelGeneration.Add(1)
}

func (m *Model) CancelGeneration() uint64 {
	return m.cancelGeneration.Load()
}

func (m *Model) IsCancelRequested(startGeneration uint64) bool {
	return m.cancelGeneration.Load() != startGeneration
}
