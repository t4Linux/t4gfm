...
var (
	...
	FilePanelItemCursorStyle       lipgloss.Style
	FilePanelSymlinkStyle          lipgloss.Style
...
func LoadThemeConfig() { //nolint: funlen // Variable initialization
	...
	FilePanelItemSelectedStyle = lipgloss.NewStyle().Foreground(SidebarBorderActiveColor).
		Background(filePanelItemSelectedBGColor).Bold(true)
	FilePanelItemCursorStyle = lipgloss.NewStyle().Foreground(filePanelItemSelectedFGColor).
		Background(filePanelItemSelectedBGColor).Bold(true)
	FilePanelSymlinkStyle = lipgloss.NewStyle().Foreground(hintColor).Background(FilePanelBGColor)
	...
	SidebarSelectedStyle = lipgloss.NewStyle().Foreground(sidebarItemSelectedFGColor).
		Background(sidebarItemSelectedBGColor).Bold(true)
