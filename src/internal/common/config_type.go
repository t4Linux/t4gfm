...
type ConfigType struct {
	Theme string `toml:"theme" comment:"Theme name to load"`
	...
	DefaultOpenFilePreview bool   `toml:"default_open_file_preview" comment:"\nWhether to open file preview automatically every time t4gfm is opened."`
	...
	SidebarWidth            int      `toml:"sidebar_width" comment:"\nThe length of the sidebar(excluding borders). If you don't find to display the sidebar, you can input 0 directly. If you want to display the value, please place it in the range of 5-25."`
...
type HotkeysType struct {
	...
	OpenT4gfmPrompt []string `toml:"open_t4gfm_prompt"`
