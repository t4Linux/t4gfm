...
import (
	...
	internal "github.com/t4Linux/t4gfm/src/internal"
)
		...
		Commands: []*cli.Command{
			{
				...
				Action: func(_ context.Context, c *cli.Command) error {
					...
					fmt.Printf("%-*s %s\n", common.HelpKeyColumnWidth,
						configStyle.Render("[Configuration directory path]"), variable.AppMainDir)
					fmt.Printf("%-*s %s\n", common.HelpKeyColumnWidth,
						dataStyle.Render("[Data directory path]"), variable.AppDataDir)
					return nil
				},
				Flags: []cli.Flag{
					&cli.BoolFlag{
...
func appAction(_ context.Context, c *cli.Command) error {
	...
	// If no args are called along with "gfm" use current dir
